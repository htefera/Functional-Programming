...
class AnagramsSuite extends munit.FunSuite:
  ...
  // put the list in ascending order in the Occurrences list
  test("sentenceOccurrences: Haftamu Hailu(8pts)") {
    assertEquals(sentenceOccurrences(List("Haftamu","Hailu")),List(('a',3), ('f',1), ('h',2), ('i',1), ('l',1), ('m',1), ('t',1), ('u',2)))

  }

  test("dictionaryByOccurrences.get: eat (10pts)") {
    // takes occurrence list
